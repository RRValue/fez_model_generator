...
class LevelParser
{
    ...
    using BackgroundPlaneGeometriesResult = std::optional<Level::BackgroundPlaneGeometries>;
...
private:
    ...
    BackgroundPlaneGeometriesResult parseBackgroundPlanes(const Level::BackgroundPlanes& backgroundPlanes);
